 ...
 */
class ReduceAggregation implements ResolvesToAny
{
    ...
    public function __construct(
        ...
        $this->input = $input;
        if (\is_array($initialValue) && ! \array_is_list($initialValue)) {
            throw new \InvalidArgumentException('Expected $initialValue argument to be a list, got an associative array.');
        }
