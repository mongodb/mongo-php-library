...
final class BucketStage implements StageInterface, OperatorInterface
{
    ...
    /**
     * @var BSONArray|PackedArray|array|string $boundaries An array of values based on the groupBy expression that specify the boundaries for each bucket. Each adjacent pair of values acts as the inclusive lower boundary and the exclusive upper boundary for the bucket. You must specify at least two boundaries.
     ...
     */
    public readonly PackedArray|BSONArray|array|string $boundaries;
