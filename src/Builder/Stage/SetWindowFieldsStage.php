...
final class SetWindowFieldsStage implements StageInterface, OperatorInterface
{
    ...
    /**
     * @var Document|Serializable|array|stdClass|string $output Specifies the field(s) to append to the documents in the output returned by the $setWindowFields stage. Each field is set to the result returned by the window operator.
