...
final class NearOperator implements FieldQueryInterface, OperatorInterface
{
    ...
    /** @var Optional|Decimal128|Int64|float|int|string $maxDistance Distance in meters. Limits the results to those documents that are at most the specified distance from the center point. */
