...
final class SortArrayOperator implements ResolvesToArray, OperatorInterface
{
    ...
    /** @var Document|Serializable|Sort|array|int|stdClass|string $sortBy The document specifies a sort ordering. */
    public readonly Document|Serializable|Sort|stdClass|array|int|string $sortBy;
